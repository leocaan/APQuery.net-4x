...
namespace QueryFramework.Query.SqlSyntex
{
   ...
   public abstract class SqlExpr
   {
      ...
      public static SqlBinaryExpr Add(SqlOperableExpr left, SqlOperableExpr right)
         => new SqlBinaryExpr(left, right, SqlBinaryOperator.Add);
      ...
      public static SqlAliasReferenceExpr AsReference(string alias)
         => new SqlAliasReferenceExpr(alias);
      ...
      public static SqlExplicitCastExpr Cast(SqlOperableExpr operand, Type type)
        => new SqlExplicitCastExpr(operand, type);
      ...
      public static SqlBinaryExpr Divide(SqlOperableExpr left, SqlOperableExpr right)
         => new SqlBinaryExpr(left, right, SqlBinaryOperator.Divide);
      ...
      public static SqlLateralJoinExpr LateralJoin(SqlQuerySourceExpr source)
         => new SqlLateralJoinExpr(source);
      ...
      public static SqlBinaryExpr Modulo(SqlOperableExpr left, SqlOperableExpr right)
         => new SqlBinaryExpr(left, right, SqlBinaryOperator.Modulo);

      public static SqlBinaryExpr Multiplay(SqlOperableExpr left, SqlOperableExpr right)
         => new SqlBinaryExpr(left, right, SqlBinaryOperator.Multiply);
      ...
      public static SqlParameterExpr Parameter(object value, string name)
         => new SqlParameterExpr(value, name);
      ...
      public static SqlBinaryExpr Subtract(SqlOperableExpr left, SqlOperableExpr right)
         => new SqlBinaryExpr(left, right, SqlBinaryOperator.Subtract);
