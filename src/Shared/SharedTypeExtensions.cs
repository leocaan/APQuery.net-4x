...
namespace System
{
   ...
   internal static class SharedTypeExtensions
   {
      ...
      public static bool IsInstantiable(this Type type)
         => IsInstantiable(type.GetTypeInfo());
      ...
      public static IEnumerable<Type> GetGenericTypeImplementations(this Type type, Type interfaceOrBaseType)
      {
         ...
         {
            return
               (interfaceOrBaseType.GetTypeInfo().IsInterface ? typeInfo.ImplementedInterfaces : type.GetBaseTypes())
                  .Union(new[] { type })
                  .Where(
      ...
      private static readonly Dictionary<Type, object> _commonTypeDictionary
      ...
      public static object GetDefaultValue(this Type type)
      {
         ...
         return
            _commonTypeDictionary.TryGetValue(type, out value)
               ? value
      ...
      public static IEnumerable<TypeInfo> GetConstructableTypes(this Assembly assembly)
         => assembly.GetLoadableDefinedTypes().Where(
               t => !t.IsAbstract && !t.IsGenericTypeDefinition);
