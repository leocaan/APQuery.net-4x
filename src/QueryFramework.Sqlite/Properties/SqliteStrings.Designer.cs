...
namespace QueryFramework.Internal
{
	...
	public static class SqliteStrings
	{
		private static readonly ResourceManager _resourceManager
			= new ResourceManager("QueryFramework.Sqlite.Properties.SqliteStrings", typeof(SqliteStrings).GetTypeInfo().Assembly);
		...
		/// <summary>
		/// The provider '{providerName}' not supported 'RIGHT OUT JOIN'.
		/// </summary>
		public static string SqlSyntex_NotSupported_RightOutJoin_Expr(object providerName)
		{
			return string.Format(CultureInfo.CurrentCulture, GetString("SqlSyntex_NotSupported_RightOutJoin_Expr", "providerName"), providerName);
		}
