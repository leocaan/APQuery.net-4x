...
namespace QueryFramework.Storage.Internal
{
   ...
   public class MySqlMaxLengthMapping : RelationalTypeMapping
   {
      ...
      public MySqlMaxLengthMapping(string storeType, Type clrType, DbType? dbType = null)
         : this(storeType, clrType, dbType, unicode: false, size: null)
      {
      }


      public MySqlMaxLengthMapping(string storeType, Type clrType, DbType? dbType,
